...
webcam.set(3, 480)		# I have found this to be about the highest-
webcam.set(4, 360)	# 	resolution you'll want to attempt on the pi

frontalface = cv2.CascadeClassifier("/home/pi/opencv/opencv-3.4.3/data/haarcascades/haarcascade_frontalface_alt2.xml")		# frontal face pattern detection
profileface = cv2.CascadeClassifier("/home/pi/opencv/opencv-3.4.3/data/haarcascades/haarcascade_profileface.xml")		# side face pattern detection
